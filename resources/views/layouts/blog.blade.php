...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
			...
			<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>			
  			<script src="{{ asset('blog/js/easing.min.js') }}"></script>			
			<script src="{{ asset('blog/js/hoverIntent.js') }}"></script>
			<script src="{{ asset('blog/js/superfish.min.js') }}"></script>	
			<script src="{{ asset('blog/js/jquery.ajaxchimp.min.js') }}"></script>
			<script src="{{ asset('blog/js/jquery.magnific-popup.min.js') }}"></script>	
    		<script src="{{ asset('blog/js/jquery.tabs.min.js') }}"></script>						
			...
			<script src="{{ asset('blog/js/simple-skillbar.js') }}"></script>							
